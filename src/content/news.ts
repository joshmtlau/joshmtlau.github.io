...
const newsItems = [
    {
      ...
      content: `Our paper SEQC: Stratify-Elaborate Quantum Compilation Towards Modular Hybrid Architectures ` +
               `got accepted into <a href="https://qce.quantum.ieee.org/2026/" class="link">QCE'26</a>! See you in Toronto.`,
    },
    {
    ...
    },
    {
      ...
      content: `Our paper <a href="https://arxiv.org/abs/2508.04092" class="link">A Lazy Resynthesis Approach for Simultaneous T Gate and Two-Qubit Gate Optimization of Quantum Circuits</a> ` +
               `got accepted into <a href="https://qce.quantum.ieee.org/2025/" class="link">QCE'25</a>! See you in Albuquerque.`,
    },
    {
